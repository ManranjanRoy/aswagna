...
public class SubCatagorylistAdaptor extends RecyclerView.Adapter<SubCatagorylistAdaptor.ImageViewHolder> {
private Context mContext;
private List<SubCatagoryModel> mUploads;

public SubCatagorylistAdaptor(Context mContext, List<SubCatagoryModel> mUploads) {
