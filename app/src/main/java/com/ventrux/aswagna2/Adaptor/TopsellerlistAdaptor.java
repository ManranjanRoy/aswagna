...
public class TopsellerlistAdaptor extends RecyclerView.Adapter<TopsellerlistAdaptor.ImageViewHolder> {
private Context mContext;
private List<SellerModel> mUploads;

public TopsellerlistAdaptor(Context mContext, List<SellerModel> mUploads) {
...
public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_seller, parent, false);
...
public void onBindViewHolder(final ImageViewHolder holder, int position) {
        ...
        final SellerModel uploadCurrent = mUploads.get(position);
